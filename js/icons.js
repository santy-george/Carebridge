...
(function () {
  var S = {
    ...
    'wellness-home':'<path d="M4 11 12 4.5 20 11"/><path d="M6 10.5V20h12v-9.5"/><path d="M9.2 14.2c1.2-1.8 4.4-1.8 5.6 0 1.1 1.7-.4 3.4-2.8 5-2.4-1.6-3.9-3.3-2.8-5z"/>',
    'medicine-care':'<path d="M7.1 16.9a3.7 3.7 0 0 1 0-5.2l4.6-4.6a3.7 3.7 0 1 1 5.2 5.2l-4.6 4.6a3.7 3.7 0 0 1-5.2 0z"/><path d="m9.4 9.4 5.2 5.2"/><path d="M4 6.5h4M6 4.5v4"/>',
    'health-records':'<path d="M6 3.5h8l4 4v13H6z"/><path d="M14 3.5v4h4"/><path d="M8.5 14h2l1.2-2.5 1.7 5 1.1-2.5h1"/>',
    'care-team':'<path d="M12 20s-7-4.7-7-9.5A4 4 0 0 1 12 7a4 4 0 0 1 7 3.5C19 15.3 12 20 12 20z"/><path d="M8.5 12h2l1-2 1.6 4 1-2H16"/>',
    'wellness-tools':'<path d="M5 18.5c4.6-.3 7.4-3.1 7.8-7.8C8.1 11.1 5.3 13.9 5 18.5z"/><path d="M12.5 11.5c.7-3.8 3.1-6.1 6.5-6.5-.2 3.7-2.3 6.2-6.5 6.5z"/><path d="M12 20v-8.5"/><path d="M8.5 20h7"/>',
    ...
    flower:'<circle cx="12" cy="12" r="2.6"/><ellipse cx="12" cy="6.3" rx="2.6" ry="3.6"/><ellipse cx="12" cy="17.7" rx="2.6" ry="3.6"/><ellipse cx="6.3" cy="12" rx="3.6" ry="2.6"/><ellipse cx="17.7" cy="12" rx="3.6" ry="2.6"/>',
    edit:'<path d="M4 20h4L18.5 9.5a2.1 2.1 0 0 0 0-3l-1-1a2.1 2.1 0 0 0-3 0L4 15.5z"/><line x1="13.5" y1="6.5" x2="17.5" y2="10.5"/>',
    watch:'<rect x="6.5" y="7.5" width="11" height="9" rx="2.4"/><path d="M9 7.5V4.5h6v3"/><path d="M9 16.5v3h6v-3"/><line x1="12" y1="9.8" x2="12" y2="12" /><line x1="12" y1="12" x2="13.6" y2="12.9"/>',
    journal:'<path d="M6 3.5h9.5A2.5 2.5 0 0 1 18 6v14.5H8.5A2.5 2.5 0 0 1 6 18z"/><path d="M6 6a2.5 2.5 0 0 1 2.5-2.5" /><line x1="9.5" y1="8.5" x2="14.5" y2="8.5"/><line x1="9.5" y1="12" x2="14.5" y2="12"/>'
  };
  var fill = { more:1 };
  var defs = '';
  for (var k in S) {
