...
(function () {
  ...
  var MEMBER = '<aside class="drawer" id="addMember" style="width:520px"><div class="drawer__head"><span class="drawer__title">Add member</span>'+XBTN+'</div>'
    ...
    +'<div class="field"><label>Care model</label><select><option>Self Care</option><option>Virtual Care</option><option selected>Direct Care</option></select></div>'
